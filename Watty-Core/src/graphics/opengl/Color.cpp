...
namespace letc { namespace graphics {
	...
	WattyColor Color::grey			= WattyColor(0xff808080);
	WattyColor Color::gray			= WattyColor(0xff808080);
	...
	WattyColor Color::green			= WattyColor(0xFF00FF00);
	WattyColor Color::pink			= WattyColor(0xffff00ff);
	...
	WattyColor Color::transparent	= WattyColor(0x00000000);
