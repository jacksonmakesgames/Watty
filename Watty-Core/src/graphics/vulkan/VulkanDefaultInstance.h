...
#include <ext/stb_image/include/stb_image.h>

#define TINYOBJLOADER_IMPLEMENTATION
#include <ext/tiny_obj_loader/include/tiny_obj_loader.h>
...
const std::string MODEL_PATH = "Super_Mario.obj";
const std::string TEXTURE_PATH = "test.jpg";
...
private:
	...
	static void framebufferResizeCallback(GLFWwindow* window, int width, int height) {
		auto app = reinterpret_cast<DefaultVulkanInstance*>(glfwGetWindowUserPointer(window));
	...
	void mainLoop() {
		...
		while (!glfwWindowShouldClose(window)) {
			...
			drawFrame();
			frames++;
			if ((t->elapsed() - timer) > 1.0f) {
				timer += 1.0f;
				mspf = 1000.0 / (double)frames;

				printf("%4d fps | %4.3 mspf\r", frames, mspf);
